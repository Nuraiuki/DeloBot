...
def get_vacancy_details(vacancy_id):
    try:
        cursor.execute("""
            SELECT me.job_title, me.company_name, me.industry, me.skills, me.job_description, me.salary, 
                me.format_e, me.experience_e, me.spec, ma.user_id, ma.phone_number
            FROM main_employer me
            JOIN main_anketa ma ON me.user_id = ma.user_id
            WHERE me.vacancy_id = %s;
        """, (vacancy_id,))
